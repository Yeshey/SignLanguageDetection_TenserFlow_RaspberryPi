...
def main():
    ...
    if (args.label):
        ...
        if example_model == True:
            label_file = "./RaspberryPi/picamera2Setup/picamera2/examples/tensorflow/coco_labels.txt"
        else:
            label_file = "./TensorFlow/workspace/training_demo/exported-models/my_model_american_alphabet_sign_language/my_model_american_alphabet_sign_language/tflite_label_map.txt"

    if (args.model):
        model = args.model
    else:
        if example_model == True:
            model = "./RaspberryPi/picamera2Setup/picamera2/examples/tensorflow/mobilenet_v2.tflite"
        else:
            model = "./TensorFlow/workspace/training_demo/exported-models/my_model_american_alphabet_sign_language/my_model_american_alphabet_sign_language/model.tflite"
    ...
    while True:
        ...
        result = InferenceTensorFlow(grey, model, output_file, label_file)
